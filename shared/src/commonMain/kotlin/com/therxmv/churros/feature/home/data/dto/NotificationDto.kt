package com.therxmv.churros.feature.home.data.dto

import com.therxmv.churros.feature.home.domain.model.ActivityItem
import com.therxmv.churros.feature.home.domain.model.toActivityType
 ...
 *
 * The [payload] column is JSONB. We map it to [Map<String, String>] on the domain side for
 * simplicity; the UI layer accesses well-known keys (e.g. "chore_title", "requester_name")
 * directly without needing a typed wrapper.
 *
...
internal fun NotificationDto.toDomain(): ActivityItem = ActivityItem(
    id = id,
