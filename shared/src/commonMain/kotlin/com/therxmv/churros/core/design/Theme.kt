...
data class ChurrosColors(
    ...
    val warning: Color,
    val error: Color,
    val labelAccent: Color,
    // Role badges
    val roleParent: Color,
    val roleKid: Color,
    // Sticky notes
...
private val LightChurrosColors = ChurrosColors(
    ...
    textBrand         = HoneyTextLight,
    divider           = DividerLight,
    surfaceElevated   = SurfaceVariantLight,
    inputBackground   = InputBackgroundLight,
    navSelectedBackground = NavSelectedLight,
    navSelectedContent    = Espresso,
    navBarContainer       = SurfaceLight,
    success           = SemanticSuccess,
    info              = SemanticInfo,
    event             = SemanticEvent,
    warning           = SemanticWarning,
    error             = SemanticError,
    labelAccent       = Honey600,
    roleParent        = RoleParentColor,
    roleKid           = RoleKidColor,
...
private val DarkChurrosColors = ChurrosColors(
    ...
    inputBackground   = SurfaceElevatedDark,
    navSelectedBackground = NavSelectedDark,
    navSelectedContent    = Honey500,
    navBarContainer       = BackgroundDark,
    success           = SemanticSuccess,
    info              = SemanticInfo,
    event             = SemanticEvent,
    warning           = SemanticWarning,
